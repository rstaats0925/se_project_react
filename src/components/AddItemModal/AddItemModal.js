...
function AddItemModal({ onClose, onAddItem }) {
  ...
  return (
    <ModalWithForm
      ...
      onClose={onClose}
      onSubmit={(event) => {
        handleSubmit(event, { name, imageUrl, weather });
      }}
    >
      ...
      <div className="input-block">
        <label htmlFor="Image" className="input-block__label">
          Image
        </label>
        <input
          id="Image"
      ...
      <div onChange={handleWeatherChange}>
        <div className="radio-block">
          ...
          />
          <label htmlFor="Hot" className="radio-block__label">
            Hot
          </label>
        </div>
        <div className="radio-block">
          <input
            ...
            className="radio-block__input"
          />
          <label htmlFor="Warm" className="radio-block__label">
            Warm
          </label>
        </div>
        <div className="radio-block">
          <input
            ...
            className="radio-block__input"
          />
          <label htmlFor="Cold" className="radio-block__label">
            Cold
          </label>
        </div>
      </div>
